"""
Unit tests for app.retrieval.hybrid_retriever module.
"""
import pytest
...
class TestReranker:
    ...
    @patch("app.retrieval.hybrid_retriever.CrossEncoder")
    def test_reranker_init_success(self, mock_cross_encoder):
    ...
    @patch("app.retrieval.hybrid_retriever.CrossEncoder")
    def test_reranker_init_failure(self, mock_cross_encoder):
    ...
    def test_rerank_with_model(self):
        ...
        reranker.available = True
        reranker.model = Mock()
        reranker.model.predict.return_value = [0.8, 0.2, 0.6]
...
class TestHybridRetriever:
    ...
    def test_sparse_search(self, mock_bm25):
        ...
        assert len(results) == 2  # k * 3 but only 3 docs
    ...
    def test_dense_search(self, mock_bm25):
        ...
        # Check that scores are converted (1.0 - score/2.0)
